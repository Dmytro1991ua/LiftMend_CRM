    ...
    return (
      <div className='group'>
        ...
        <input
          ref={ref}
          className={cn(
            'relative flex h-10 w-full rounded-md border border-input bg-background py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-gray-400 text-ellipsis disabled:cursor-not-allowed disabled:opacity-50 ',
            error
