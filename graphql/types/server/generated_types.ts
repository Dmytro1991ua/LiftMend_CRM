...
> = ResolversObject<{
  __resolveType: TypeResolveFn<
    'ElevatorRecordConnection' | 'NotificationConnection' | 'RepairJobConnection' | 'TechnicianRecordConnection',
    ParentType,
    ContextType
  >;
...
> = ResolversObject<{
  __resolveType: TypeResolveFn<
    'ElevatorRecordEdge' | 'NotificationEdge' | 'RepairJobEdge' | 'TechnicianRecordEdges',
    ParentType,
    ContextType
  >;
