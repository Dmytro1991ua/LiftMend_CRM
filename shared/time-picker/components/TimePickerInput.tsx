  ...
  (
    ...
    return (
      <Input
        ref={ref}
        className={cn(
          'w-[48px] text-center text-sm font-mono rounded-2xl tabular-nums caret-transparent focus:bg-accent focus:text-accent-foreground [&::-webkit-inner-spin-button]:appearance-none',
          className
        )}
        disabled={disabled}
        id={id || picker}
