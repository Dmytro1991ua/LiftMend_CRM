...
export const DETAILS_PAGE_ALERT_MESSAGE: Record<string, React.JSX.Element> = {
  Completed: <BaseAlert description={EDIT_BUTTON_COMPLETED_STATUS_TOOLTIP_MESSAGE} variant='warning' />,
  Cancelled: <BaseAlert description={EDIT_BUTTON_CANCELLED_STATUS_TOOLTIP_MESSAGE} variant='warning' />,
};
